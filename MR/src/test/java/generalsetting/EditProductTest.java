...
public class EditProductTest  extends TestBase {
  ...
  @Test(priority = 1)
  public void UserCanEditProduct() throws InterruptedException {
	  homepageObject=new HomePage(driver);
			...
			ProductsObjects.editproduct();
			Thread.sleep(500);
			ProductsDetailsObjects.editproductform();
			softassert.assertTrue(ProductsDetailsObjects.editsuccessmsg.getText().contains("success"));
